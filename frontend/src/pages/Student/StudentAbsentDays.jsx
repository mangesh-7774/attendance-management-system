...
const StudentAbsentDays = () => {
  ...
  const fetchAttendance = async (month) => {
    try {
      ...
      setMessage("Failed to fetch absent records");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="pt-24 px-6 bg-gray-50 min-h-screen">
      {/* Header */}
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-gray-800">Absent Records</h2>
      ...
      {absentRecords.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-18 bg-white rounded-2xl shadow-md mb-10">
          <FiAlertCircle className="text-6xl text-red-400 mb-6" />
          ...
          <p className="text-gray-500 text-center">
            You have no absent attendance records for this month.
          </p>
        </div>
      )}
...
export default StudentAbsentDays;
